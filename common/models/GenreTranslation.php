 ...
 */
final class GenreTranslation extends ActiveRecord
{
    public static function tableName(): string
    {
        return '{{%genre_translation}}';
    }
    ...
    public function rules(): array
    {
        return [
            ...
            [['genre_id'], 'exist', 'skipOnEmpty' => true, 'targetClass' => Genre::class, 'targetAttribute' => ['genre_id' => 'id']],
        ];
    }
